        ...
        <div className="relative border-l-2 border-gray-300 ml-4 md:ml-6 pl-6 space-y-6 pb-2">
            ...
            <TimelineItem time="เย็น" title="Dinner: Hida Beef 🥩" colorClass="border-red-600" icon={<Utensils/>}>
                ...
                <ul className="list-disc list-inside text-sm text-gray-600 ml-2 mt-1">
                    <li><a href={getMapLink("Maruaki Hida Takayama")} target="_blank" className="text-red-600 font-medium underline">Maruaki</a> (ยอดฮิต เมนูหลากหลาย)</li>
                    <li><a href={getMapLink("Ajikura Tengoku")} target="_blank" className="text-red-600 font-medium underline">Ajikura Tengoku</a> (ใกล้สถานี)</li>
                </ul>
            </TimelineItem>
        </div>
      </div>
        ...
        <div className="relative border-l-2 border-gray-300 ml-4 md:ml-6 pl-6 space-y-6 pb-2">
            <TimelineItem time="เช้า" title="Morning Market & Old Town" colorClass="border-orange-500">
                <ul className="list-disc list-inside text-sm text-gray-600 mt-2 space-y-1">
                    <li><a href={getMapLink("Miyagawa Morning Market")} target="_blank" className="font-medium underline">📍 Miyagawa Morning Market</a></li>
                    <li><a href={getMapLink("Sanmachi Suji")} target="_blank" className="font-medium underline">📍 Sanmachi Suji</a></li>
                </ul>
            </TimelineItem>
            ...
            <TimelineItem time="14:00 - 16:34" title="Move to Nagoya" colorClass="border-blue-400">
             ...
             <TimelineItem time="เย็น" title="Nagoya Night" colorClass="border-purple-500">
                 <ul className="list-disc list-inside text-sm text-gray-600 mt-2 space-y-1">
                     <li><a href={getMapLink("Osu Shopping Street")} target="_blank" className="font-medium underline">📍 Osu Shopping Street</a></li>
                     <li><a href={getMapLink("Oasis 21")} target="_blank" className="font-medium underline">📍 Oasis 21</a></li>
      ...
      <div>
        ...
        <div className="relative border-l-2 border-gray-300 ml-4 md:ml-6 pl-6 space-y-6 pb-2">
            <TimelineItem time="08:00" title="Yanagibashi Central Market" colorClass="border-cyan-500">
                <p className="text-sm text-gray-600">ทานมื้อเช้า ซูชิสด/ซีฟู้ด ที่ <a href={getMapLink("Yanagibashi Central Market")} target="_blank" className="text-cyan-600 font-bold underline">📍 ตลาดปลา Yanagibashi</a></p>
            </TimelineItem>
            ...
            <TimelineItem time="10:00 - 11:40" title="Move to Tokyo (Shinkansen)" colorClass="border-blue-600" icon={<Train/>}>
             ...
             <TimelineItem time="บ่าย/เย็น" title="Tokyo Shopping" colorClass="border-purple-500" icon={<ShoppingBag/>}>
                ...
                <ul className="list-disc list-inside text-sm text-gray-600 ml-2">
                    <li>🛒 <a href={getMapLink("Don Quijote Tokyo")} target="_blank" className="font-medium underline">Donki</a></li>
                    <li>👟 <a href={getMapLink("ABC-MART Tokyo")} target="_blank" className="font-medium underline">ABC Mart</a></li>
                </ul>
            </TimelineItem>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="relative border-l-2 border-gray-300 ml-4 md:ml-6 pl-6 space-y-6 pb-2">
             <TimelineItem time="10:30 - 15:30" title="Kawagoe (Little Edo) 🍡" colorClass="border-blue-400">
                ...
                <ul className="list-disc list-inside text-sm text-gray-600 mt-2 space-y-1">
                    <li><a href={getMapLink("Kurazukuri Street")} target="_blank" className="font-medium underline">📍 Kurazukuri Street</a></li>
                    <li><a href={getMapLink("Kashiya Yokocho")} target="_blank" className="font-medium underline">📍 Kashiya Yokocho</a></li>
                </ul>
            </TimelineItem>

             <TimelineItem time="ค่ำ" title="Tokyo Beef Dinner 🥩" colorClass="border-red-700">
                 <ul className="list-disc list-inside text-sm text-gray-700 mt-1">
                    <li><b>ประหยัด:</b> <a href={getMapLink("Gyukatsu Motomura")} target="_blank" className="text-orange-600 font-bold underline">Gyukatsu Motomura</a></li>
                    <li><b>ปานกลาง:</b> <a href={getMapLink("Yakiniku Like")} target="_blank" className="text-blue-600 font-bold underline">Yakiniku Like</a></li>
                    <li><b>หรู:</b> <a href={getMapLink("Jojoen")} target="_blank" className="text-purple-600 font-bold underline">Jojoen</a></li>
                </ul>
            </TimelineItem>
        </div>
      </div>
         ...
         <div className="relative border-l-2 border-gray-300 ml-4 md:ml-6 pl-6 space-y-6 pb-2">
            <TimelineItem time="เช้า/บ่าย" title="Tokyo Food & Shopping" colorClass="border-green-400">
                <div className="mt-3 space-y-4 text-sm text-gray-700">
                    <div>
                        <span className="font-bold text-blue-800">🐟 ตลาดปลา Tsukiji:</span> <a href={getMapLink("Tsukiji Outer Market")} target="_blank" className="underline">Outer Market</a>
                    </div>
                    <div>
                        <span className="font-bold text-red-800">🥩 เนื้อเทพราคาประหยัด:</span> <a href={getMapLink("Jiromaru Shinjuku")} target="_blank" className="underline font-medium text-red-700">Jiromaru Shinjuku</a>, <a href={getMapLink("Roast Beef Ono")} target="_blank" className="underline font-medium text-red-700">Roast Beef Ono</a>
                    </div>
                </div>
            </TimelineItem>
