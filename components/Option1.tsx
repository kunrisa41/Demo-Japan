  ...
  return (
    <div className="space-y-8 animate-fadeIn">
        ...
        <div className="relative border-l-2 border-gray-300 ml-4 md:ml-6 pl-6 space-y-6 pb-2">
          ...
          >
            <TransportBox title="วิธีเดินทาง" type="train">
              ...
              <b>ปลายทาง:</b> ลงสถานี <a href="https://maps.google.com/?q=Meitetsu+Nagoya+Station" target="_blank" className="text-blue-600 underline hover:text-blue-800">Meitetsu Nagoya</a>
            </TransportBox>
          </TimelineItem>
          ...
          >
            <ul className="list-disc list-inside text-sm text-gray-700 mt-2 space-y-1">
                <li>เที่ยวชม <a href="https://maps.google.com/?q=Nagoya+Castle" target="_blank" className="text-red-600 font-medium hover:underline">📍 Nagoya Castle</a> และพระราชวัง Honmaru Goten</li>
                <li>ทานมื้อเที่ยงที่ 🍣 <b><a href="https://maps.google.com/?q=Yanagibashi+Central+Market" target="_blank" className="text-red-600 font-medium hover:underline">📍 ตลาดปลา Yanagibashi</a></b> (มีร้านซูชิสดๆ เยอะมาก)</li>
            </ul>
          </TimelineItem>
          ...
          >
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 mt-1">
                <li>ไหว้พระวัด <a href="https://maps.google.com/?q=Osu+Kannon" target="_blank" className="text-red-600 font-medium hover:underline">📍 Osu Kannon</a></li>
                <li>เดินช้อปปิ้งที่ <a href="https://maps.google.com/?q=Osu+Shopping+Street" target="_blank" className="text-red-600 font-medium hover:underline">📍 Osu Shopping Street</a></li>
                <li>แวะถ่ายรูป <a href="https://maps.google.com/?q=Oasis+21" target="_blank" className="text-red-600 font-medium hover:underline">📍 Oasis 21</a> (ยานอวกาศน้ำ) ช่วงค่ำ</li>
            </ul>
          </TimelineItem>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="relative border-l-2 border-gray-300 ml-4 md:ml-6 pl-6 space-y-6 pb-2">
            <TimelineItem time="08:30 - 11:00" title="Move to Takayama" colorClass="border-blue-400">
                <TransportBox type="train">
                    <b>ขึ้นรถที่:</b> สถานี <a href="https://maps.google.com/?q=Nagoya+Station" target="_blank" className="text-blue-600 underline">📍 JR Nagoya</a><br/>
                    ...
                    <div className="bg-white mt-2 rounded-lg border-2 border-cyan-200 overflow-hidden animate-fadeIn">
                        <div className="p-5 space-y-4">
                            ...
                            <div className="flex">
                                ...
                                <div className="flex-1 ml-2 text-sm text-gray-700">🚌 ขึ้น <b>Ski Shuttle Bus</b> ที่ <a href="https://maps.google.com/?q=Takayama+Nohi+Bus+Center" target="_blank" className="text-blue-600 underline">📍 Nohi Bus Center</a></div>
                            </div>
                            <div className="flex">
                                <span className="w-16 font-bold text-gray-500 text-sm">13:00</span>
                                <div className="flex-1 ml-2 text-sm text-gray-700">🎿 <b>Ski Time!</b> เล่นสกี/หิมะ ที่ <a href="https://maps.google.com/?q=Mont+Deus+Hida+Kuraiyama+Snow+Park" target="_blank" className="text-blue-600 underline">📍 Mont Deus</a></div>
                            </div>
                            <div className="flex">
            ...
            <TimelineItem time="18:30" title="Dinner: Hida Beef" colorClass="border-red-600" icon={<Utensils />}>
                <p className="text-sm text-gray-600">มื้อเย็นต้องจัด! เนื้อฮิดะย่างเตาถ่านที่ร้านดัง <a href="https://maps.google.com/?q=Ajikura+Tengoku" target="_blank" className="text-red-600 font-bold underline">📍 Ajikura Tengoku</a> หรือ <a href="https://maps.google.com/?q=Maruaki+Hida+Takayama" target="_blank" className="text-red-600 font-bold underline">📍 Maruaki</a></p>
            </TimelineItem>
        </div>
      </div>
        ...
        <div className="relative border-l-2 border-gray-300 ml-4 md:ml-6 pl-6 space-y-6 pb-2">
            <TimelineItem time="08:45 - 11:00" title="Takayama Old Town" colorClass="border-pink-400">
                ...
                <ul className="list-disc list-inside text-sm text-gray-600">
                    <li>เดินตลาดเช้า <a href="https://maps.google.com/?q=Miyagawa+Morning+Market" target="_blank" className="underline">📍 Miyagawa Morning Market</a></li>
                    <li>กินซูชิเนื้อฮิดะบนแครกเกอร์</li>
                    <li>แวะ <a href="https://maps.google.com/?q=Takayama+Jinya" target="_blank" className="underline">📍 Takayama Jinya</a></li>
                </ul>
            </TimelineItem>
            ...
            <TimelineItem time="18:00" title="แนะนำ: Shinsekai (Osaka)" colorClass="border-yellow-500">
                 <p className="text-sm text-gray-600">เดินย่าน <a href="https://maps.google.com/?q=Shinsekai+Osaka" target="_blank" className="text-yellow-700 font-bold underline">📍 Shinsekai</a> กินของทอด Kushikatsu ดูหอคอย Tsutenkaku</p>
            </TimelineItem>
        </div>
      </div>
        ...
        <div className="relative border-l-2 border-gray-300 ml-4 md:ml-6 pl-6 space-y-6 pb-2">
            <TimelineItem time="08:00 - 12:30" title="Kobe Sightseeing" colorClass="border-blue-600">
                ...
                <ul className="list-disc list-inside text-sm text-gray-700 mt-2 space-y-1">
                    ...
                    <li><b>Lunch:</b> เนื้อโกเบ (Steakland) หรือ ราเมง (Daiichi Asahi)</li>
                </ul>
            </TimelineItem>
            ...
            <TimelineItem time="14:00 - 17:00" title="Uji Matcha Town" colorClass="border-green-600">
                <p className="text-sm text-gray-700 mt-2">เดินถนนชาเขียว <a href="https://maps.google.com/?q=Byodoin+Omotesando" target="_blank" className="text-green-700 underline">📍 Omotesando</a> เข้าวัด <a href="https://maps.google.com/?q=Byodoin+Temple" target="_blank" className="text-green-700 underline">📍 Byodoin</a></p>
                <div className="bg-green-50 p-3 rounded border border-green-200 mt-2 text-sm text-gray-700">
                    🍵 <b>ร้านแนะนำ:</b> Nakamura Tokichi, Masuda Chaho (ซอฟท์ครีมชาเขียว), Starbucks Uji
                </div>
            </TimelineItem>
        </div>
      </div>
       ...
       <div>
        <div className="flex items-center mb-4 sticky top-0 bg-gray-100/95 backdrop-blur py-2 z-20">
          <div className="bg-gray-700 text-white font-bold px-4 py-2 rounded-lg shadow-md">Day 5</div>
        ...
        <div className="relative border-l-2 border-gray-300 ml-4 md:ml-6 pl-6 space-y-6 pb-2">
            <TimelineItem time="เช้า" title="Kuromon Market & Shopping" colorClass="border-gray-500">
                <ul className="list-disc list-inside text-sm text-gray-600 mt-2 space-y-1">
                    <li>หาของกินที่ <a href="https://maps.google.com/?q=Kuromon+Ichiba+Market" target="_blank" className="font-medium underline">📍 Kuromon Market</a></li>
                    <li>ช้อปปิ้ง <a href="https://maps.google.com/?q=Dotonbori" target="_blank" className="font-medium underline">📍 Dotonbori</a></li>
                </ul>
                <div className="mt-4">
